 ...
 */
public class RelevantDocumentReader_Cranfield extends RelevantDocumentReader {
     ...
     */
    public RelevantDocumentReader_Cranfield() throws FileNotFoundException {
        br = new BufferedReader(new InputStreamReader(
             new FileInputStream(StringHash.factory().get("queryRelevance"))));
