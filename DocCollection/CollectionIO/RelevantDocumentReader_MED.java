 ...
 */
public class RelevantDocumentReader_MED extends RelevantDocumentReader {
     ...
     */
    public RelevantDocumentReader_MED() throws FileNotFoundException {
        br = new BufferedReader(new InputStreamReader(
             new FileInputStream("med/MED.REL")));
